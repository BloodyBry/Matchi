...
<div class="card">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:10px;">
        <a href="{{ route('manager.center.index') }}" class="btn"><x-icon name="building" :size="15" /> Mes centres</a>
        <a href="{{ route('manager.fields.index') }}" class="btn"><x-icon name="stadium" :size="15" /> Mes terrains</a>
        <a href="{{ route('manager.reservations.index') }}" class="btn"><x-icon name="clipboard" :size="15" /> Réservations</a>
    </div>
</div>
